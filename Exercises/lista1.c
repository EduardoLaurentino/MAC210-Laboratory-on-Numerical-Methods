...
// (O arquivo float.h é um header padrâo do C
//  e deve estar em algum lugar na sua máquina)

// explique porque a função abaixo calcula
...
// Resolvendo a equação 10^(-4) x^2 + 16 x + 10^(-4) = 0
// Mostre que em aritmeética exata os números
